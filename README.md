# cheeseOS
cheeseOS is an open-source Linux distrobution based on Arch Linux. It also uses Ezarch, which can be found here: https://sourceforge.net/projects/ezarch/

# How to create ISO file
Run steps.sh in the working directory as root.
